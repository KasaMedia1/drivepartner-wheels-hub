...
export const products: Product[] = [
  ...
  },
  {
    ...
    features: [
      { title: "Dual motor 750W×2", description: "Două motoare independente de 750W cu cuplu combinat de 130 Nm pentru tracțiune și putere inegalabile pe orice teren." },
      { title: "Baterie Samsung 20AH", description: "Celule Samsung de înaltă calitate oferă o autonomie de 100-120 km și o durabilitate excepțională pe termen lung." },
      { title: "Display 4G LCD cu GPS tracking", description: "Display inteligent cu conectivitate 4G, tracking GPS în timp real și port USB Type-C. Monitorizează-ți bicicleta oricând, oriunde." },
      { title: "Sistem anti-furt inteligent", description: "Sistem avansat de protecție anti-furt cu alerte în timp real și localizare GPS pentru liniștea ta sufletească." },
      { title: "Suspensie completă", description: "Suspensie față și spate pentru un confort excepțional pe orice tip de teren, de la asfalt la off-road." },
      { title: "Anvelope fat 26×4.0", description: "Anvelope late de 4 inch pentru tracțiune maximă pe nisip, zăpadă, noroi sau pietriș." },
    ],
    specs: {
      "Motor": "Dual 750W×2",
      "Cuplu": "65 Nm × 2",
  ...
  },
  {
    ...
    features: [
      { title: "Dual motor 750W×2", description: "Două motoare independente de 750W pentru tracțiune integrală și putere neegalată pe orice suprafață." },
      { title: "Baterie Samsung 20AH", description: "Celule premium Samsung pentru autonomie extinsă de 100-120 km și durabilitate pe termen lung." },
      { title: "GPS tracking & anti-furt", description: "Sistem integrat de localizare GPS și protecție anti-furt cu alerte în timp real pe telefon." },
      { title: "Design roșu premium", description: "Finisaj roșu vibrant pe cadru din aliaj de aluminiu, pentru o prezență vizuală puternică." },
    ],
    specs: {
      "Motor": "Dual 750W×2",
      "Cuplu": "65 Nm × 2",
  ...
  },
  {
    ...
    features: [
      { title: "Baterie uriașă 52V 27AH", description: "Una dintre cele mai mari baterii din gamă, oferind o autonomie de 120-140 km în modul asistat. Ideală pentru călătorii lungi fără grija încărcării." },
      { title: "Design retro iconic", description: "Cadru cu design retro elegant care combină nostalgia cu tehnologia de ultimă generație." },
      { title: "Suspensie completă", description: "Suspensie față și spate pentru confort maxim pe orice tip de teren, inclusiv pe drumuri cu denivelări." },
      { title: "Anvelope fat 20×4.0", description: "Anvelope late de 4 inch pe roți de 20\" pentru stabilitate și tracțiune excelente, cu un centru de greutate coborât." },
    ],
    specs: {
  ...
  },
  {
    ...
    features: [
      { title: "Cadru color-changing", description: "Cadru din aliaj de aluminiu cu efect color-changing unic care își schimbă nuanța în funcție de unghiul luminii." },
      { title: "Motor Bafang 750W cu senzor cuplu", description: "Motor Bafang premium cu senzor de cuplu integrat pentru cea mai naturală și intuitivă experiență de pedalare electrică." },
      { title: "Baterie Samsung 20AH", description: "Celule Samsung de top pentru fiabilitate pe termen lung și autonomie de 100-120 km în mod asistat." },
      { title: "Shimano 8 viteze", description: "Transmisie Shimano cu 8 trepte pentru versatilitate sporită și schimbări de viteză precise." },
      { title: "Suspensie completă", description: "Amortizare față și spate pentru confort maxim pe drumuri dificile și trasee off-road." },
      { title: "Frâne hidraulice premium", description: "Sistem de frânare hidraulic de înaltă performanță pentru opriri sigure la orice viteză." },
    ],
    specs: {
      "Motor": "750W Bafang",
      "Cuplu": "65 Nm",
  ...
  },
  {
    ...
    features: [
      { title: "Motor 500W eficient", description: "Motor de 500W care oferă un echilibru excelent între putere și eficiență energetică pentru aventuri de zi cu zi." },
      { title: "Baterie Samsung 18AH", description: "Celule Samsung premium pentru o autonomie de 80-90 km și o durată de viață extinsă a bateriei." },
      { title: "Anvelope fat 26×4.0", description: "Anvelope late pentru tracțiune excelentă pe orice suprafață – asfalt, nisip, zăpadă sau noroi." },
      { title: "Conectivitate Bluetooth", description: "Aplicație DUOTTS dedicată pentru monitorizarea performanțelor și setărilor bicicletei." },
    ],
    specs: {
      "Motor": "500W",
      "Cuplu": "55 Nm",
  ...
  },
  {
    ...
    features: [
      { title: "Dual motor 750W×2", description: "Tracțiune integrală cu două motoare puternice de 750W pentru performanță maximă pe orice teren." },
      { title: "Suspensie completă față-spate", description: "Sistem de amortizare complet pentru un confort excepțional și control sporit pe trasee tehnice." },
      { title: "Baterie Samsung 20AH", description: "Celule Samsung de înaltă calitate pentru autonomie extinsă și fiabilitate pe termen lung." },
      { title: "Conectivitate Bluetooth & APP", description: "Monitorizare completă prin aplicația DUOTTS cu date în timp real despre performanță și baterie." },
    ],
    specs: {
      "Motor": "Dual 750W×2",
      "Cuplu": "65 Nm × 2",
