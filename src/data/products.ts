...
import duottsF20_2 from "@/assets/duotts-f20-2.jpg";
import duottsF20_3 from "@/assets/duotts-f20-3.jpg";
import duottsF20_4 from "@/assets/duotts-f20-4.jpg";
import duottsF20_5 from "@/assets/duotts-f20-5.jpg";
import duottsF20_6 from "@/assets/duotts-f20-6.jpg";
...
import f20Motor from "@/assets/features/f20-motor.jpg";
import f20Headlight from "@/assets/features/f20-headlight.jpg";
import f20Brakes from "@/assets/features/f20-brakes.jpg";
import f20Display from "@/assets/features/f20-display.jpg";
...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "retro",
    image: duottsF20_1,
    gallery: [duottsF20_1, duottsF20_2, duottsF20_3, duottsF20_4, duottsF20_5, duottsF20_6],
    shortDescription: "E-bike retro cu motor 1000W, baterie 52V 27AH și autonomie de 140 km.",
    longDescription: "DUOTTS F20 combină cu măiestrie designul vintage al cursierelor clasice cu cea mai avansată tehnologie e-bike, creând o adevărată operă de artă pe roți. Cu motor puternic de 1000W, baterie de 52V 27AH și suspensie completă, oferă o experiență de conducere fără egal pe orice teren.",
    price: Math.round(1349 * EUR),
    tagline: "Retro redefinit: stil și performanță",
    taglineDescription: "Bicicleta electrică retro combină farmecul vintage cu funcționalitatea modernă. Designul inspirat din epoca de aur și suspensia completă avansată asigură deplasări line, stabile și confortabile pe orice teren.",
    highlights: [
      { icon: "motor", value: "1000 W", label: "Motor puternic" },
      { icon: "range", value: "130-140 km", label: "Autonomie asistat" },
      { icon: "torque", value: "70 Nm", label: "Cuplu maxim" },
      { icon: "battery", value: "52V 27Ah", label: "Baterie DUOTTS" },
      { icon: "speed", value: "25 km/h", label: "Viteză maximă" },
      { icon: "weight", value: "150 kg", label: "Sarcină maximă" },
    ],
    features: [
      { title: "Motor 1000W fără perii", description: "Motor brushless DC rear-drive compact dar puternic, care oferă accelerare superioară, cuplu mai mare și o experiență de mers silențioasă. Cuceriți cu ușurință orice teren provocator.", image: f20Motor },
      { title: "Baterie uriașă 52V 27AH", description: "Bateria de 52V/27AH oferă o autonomie impresionantă: 50-70 km în modul electric pur și 130-140 km cu pedalare asistată. Călătorii lungi fără grija încărcării.", image: f20Battery },
      { title: "Dashboard GPS inteligent", description: "Display HD LCD de 4.5\" cu Bluetooth pentru aplicația Duotts și port Type-C. Controluri integrate pentru aprindere, claxon, semnalizare și faruri.", image: f20Display },
      { title: "Suspensie completă", description: "Furcă de suspensie față cu coroană dublă și cursă de 80mm plus amortizor spate cu arc de 3300 lb, pentru o călătorie lină pe orice teren.", image: f20Suspension },
      { title: "Faruri retro de design", description: "Far rotund mare cu 160 LUX care oferă vizibilitate și siguranță sporită. Lumina puternică iluminează drumul, asigurând vedere clară chiar și în condiții de lumină scăzută.", image: f20Headlight },
      { title: "Frâne hidraulice ZOOM", description: "Frâne hidraulice ZOOM cu dublu piston și rotoare de 180mm față și spate, oferind putere de frânare fiabilă pe orice suprafață și în orice condiții meteo.", image: f20Brakes },
      { title: "Anvelope fat Kenda 20×4.0", description: "Anvelope late Kenda de 4 inch pe roți de 20\" cu 30 TPI, oferind absorbție excelentă a șocurilor și stabilitate optimă pe orice tip de suprafață.", image: f20Fattire },
      { title: "Design retro iconic", description: "Cadru din aliaj de aluminiu cu design retro elegant, șa din piele, accente cromate și detalii complexe care îmbină nostalgia cu performanța modernă.", image: f20Frame },
    ],
    specs: {
      "Motor": "52V 1000W brushless DC rear-drive",
      "Cuplu": "70 Nm",
      "Baterie": "52V 27AH",
      "Încărcător": "58.8V 2.8A",
      "Timp de încărcare": "8-9 ore",
      "Display": "XF009 4.5\" HD LCD, Bluetooth, APP Duotts, Type-C",
      "Autonomie": "130-140 km (mod asistat) / 50-70 km (electric pur)",
      "Viteză maximă": "25 km/h",
      "Unghi maxim urcare": "30°",
      "Cadru": "Aliaj de aluminiu, design retro",
      "Ghidon": "Aliaj de aluminiu, 76 cm",
      "Manivelă": "Aliaj de aluminiu, 152 mm",
      "Transmisie": "Shimano Tourney 1×7 viteze",
      "Furculiță": "Suspensie cu coroană dublă, cursă 80mm",
      "Amortizor spate": "Arc 3300 lb",
      "Frâne": "ZOOM hidraulice dublu piston, rotor 180mm față și spate",
      "Anvelope": "Kenda 20×4.0, 30 TPI",
      "Far": "160 LUX, operare manuală",
      "Stop": "Integrare frână și semnalizare",
      "Pedale": "Aliaj de aluminiu",
      "Apărătoare": "Plastic, acoperire completă",
      "Portbagaj spate": "Oțel, sarcină max 25 kg",
      "Greutate bicicletă": "38.03 kg",
      "Dimensiuni": "1800×1050×760 mm",
      "Sistem pedalare asistată": "Senzor de viteză, 5 niveluri",
      "Înălțime recomandată": "170-200 cm",
      "Sarcină maximă": "150 kg",
      "Grad protecție": "IPX4",
      "Certificare": "CE",
      "Temperatură funcționare": "-10°C până la 40°C",
      "Include": "Încărcător, manual, kit unelte, accelerator, pedale, pompă aer, geantă telefon, oglindă retrovizoare",
    },
    available: true,
  },
  {
