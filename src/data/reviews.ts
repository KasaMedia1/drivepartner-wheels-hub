...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    text: "Am închiriat DUOTTS F26 Pro pentru un weekend la munte și a fost spectaculos. Frânele hidraulice și display-ul color sunt de top. text: "Am închiriat DUOTTS F26 Pro pentru un weekend la munte și a fost spectaculos. Frânele hidraulice și display-ul color sunt de top. Serviciul E-bike Zone e impecabil.",",
